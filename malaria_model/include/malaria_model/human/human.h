...
class HumanManager {
    ...
    bool* is_forest_goer_of;
    bool* is_plantation_worker_of;
    ...
    std::vector<std::vector<int>> journey_plan_of;
    ...
    inline void set_human_return_home_village(const int human_id) {
        this->set_human_at_village(human_id, this->home_village_of[human_id]);
    }
    ...
    inline void set_human_is_forest_goer(int human_id, bool b) {
        this->is_forest_goer_of[human_id] = b;
    }
    inline void set_human_is_plantation_worker(int human_id, bool b) {
        this->is_plantation_worker_of[human_id] = b;
    }
    ...
    inline int get_sum_num_humans() const {
        return this->sum_num_humans;
    }
    ...
    inline bool get_if_at_home(int h_index) const {
        return (this->home_village_of[h_index] == this->at_village_of[h_index]);
    }
    ...
    inline bool get_is_forest_goer(int human_id) const {
        return this->is_forest_goer_of[human_id];
    }
    inline bool get_is_plantation_worker(int human_id) const {
        return this->is_plantation_worker_of[human_id];
    }
    ...
    // Journey Plan
    inline void journey_add_location(int human_id, int location_id) {
        this->journey_plan_of[human_id].push_back(location_id);
    }
    inline bool journey_is_empty(int human_id) {
        return this->journey_plan_of[human_id].empty();
    }
    inline int journey_pop_next_location(int human_id) {
        assert(!this->journey_is_empty(human_id));
        int next_location = this->journey_plan_of[human_id].back();
        this->journey_plan_of[human_id].pop_back();
        return next_location;
    }
    inline void journey_clear(int human_id) {
        this->journey_plan_of[human_id].clear();
    }
