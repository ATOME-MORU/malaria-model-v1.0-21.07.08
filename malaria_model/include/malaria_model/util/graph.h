...
public:
    ...
    VillageGraph(const int num_vll, const float* const* distances, const std::vector<int>& ids_of_vll);
    
    void init(const float* const* distances, const std::vector<int>& ids_of_vll);
    ...
    std::vector<int> find_shortest_paths_route(int from_vll_idx, int to_vll_idx) const;
    std::vector<int> find_shortest_paths_route(int from_vll_idx, int to_vll_idx, bool verbose) const;
    float find_shortest_paths_route(
        int from_vll_idx,
        int to_vll_idx,
    ...
    int get_degree_of_village(int ii) const;
