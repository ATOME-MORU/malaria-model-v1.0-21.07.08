...
set multiplot layout 3, 1 title "RA Type" font ",8" rowsfirst downwards
...
plot for [tt = 1:10] "../batch/S01E0".(tt+1)."/prevalence_at_730.out" using (tt):3 notitle
...
plot for [tt = 1:10] "../batch/S01E0".(tt+1)."/prevalence_at_1087.out" using (tt):3 notitle
...
plot for [tt = 1:10] "../batch/S01E0".(tt+1)."/prevalence_at_1359.out" using (tt):3 notitle