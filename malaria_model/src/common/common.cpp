...
std::ostream& operator<<(std::ostream& os, LocationType loct) {
    switch(loct) {
        case LocationType::kVillage     : os << "v"; break;
        case LocationType::kForestEntry : os << "e"; break;
        case LocationType::kForestPOI   : os << "f"; break;
        default : os << "UnknownLocationType";
